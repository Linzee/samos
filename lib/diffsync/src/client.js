...
var Client = function(socket, room, diffOptions){
  ...
  this.socket.on('error', (function(error) {this.emit('error', error)}).bind(this));
...
Client.prototype.close = function(){
  this.initialized = false;
  this.socket.emit(COMMANDS.leave, this.room);
  this.socket.off(COMMANDS.remoteUpdateIncoming, this.onRemoteUpdate);
